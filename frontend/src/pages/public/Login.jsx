...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#E3FDFD] via-[#71C9CE] to-[#2563EB] font-sans">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-white/30 rounded-full blur-[120px] mix-blend-overlay"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-[#2563EB]/40 rounded-full blur-[150px] mix-blend-multiply"></div>
      ...
      <div className="relative z-10 w-full max-w-[480px] p-6 sm:p-10 m-4 bg-white rounded-2xl shadow-xl border border-white/50 animate-[fadeIn_0.6s_ease-out_forwards]">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <p className="text-center text-sm text-gray-600 font-medium">
            Belum memiliki akun?{' '}
            <Link to="/register" className="font-bold text-[#2563EB] hover:text-[#1D4ED8] hover:underline transition-colors">
              Daftar Sekarang
            </Link>
          </p>
