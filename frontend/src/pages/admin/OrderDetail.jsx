  ...
  if (errorMsg || !order) {
    return (
      <div className="bg-white p-12 rounded-2xl border border-slate-200/60 shadow-sm text-center max-w-md mx-auto space-y-4">
        ...
        <Link to="/admin/orders" className="inline-block px-4 py-2 bg-slate-100 text-slate-700 text-xs font-bold rounded-md">
          Kembali
        </Link>
      </div>
    );
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              <Link to="/admin/orders" className="text-slate-400 hover:text-primary text-sm font-bold">
                &larr; Kembali
              </Link>
            ...
            <form onSubmit={handleUpdateCompletionDate} className="w-full md:w-1/2 bg-slate-50 p-4 rounded-xl border border-slate-200/60">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-primary hover:brightness-110 active:scale-95 text-white text-xs font-bold rounded-md shadow-sm disabled:bg-slate-300 transition-all duration-150 shrink-0"
                >
                  {isUpdatingDate ? '...' : 'Ubah'}
                </button>
              </div>
              ...
              <div className="border-t border-slate-100 pt-4 flex flex-col sm:flex-row justify-between items-end gap-4">
                <button
                  ...
                  className={`px-5 py-2.5 text-xs font-bold text-white rounded-md shadow-sm transition-colors ${
                    isSavingActual ? 'bg-slate-400' : 'bg-teal-800 hover:bg-teal-700'
                  }`}
                >
